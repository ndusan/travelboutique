...
<div id="page">
  	...
  	<div id="content">
		...
		<div class="post">
			<h2 class="title">partners / edit existing</h2>
			...
			<br/>
			<form id="form" name="form" action="<?php echo BASE_PATH.'admin'.DS.'partners'.DS.$params['id'].DS.'submit'.DS;?>" method="post" enctype="multipart/form-data">
