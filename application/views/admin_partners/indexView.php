...
<div id="page">
    ...
    <div id="content">
        ...
        <div class="post">
            <h2 class="title">partners / view existing</h2>
                ...
                <table cellspacing="0" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr onmouseover="className='tr_over'" onmouseout="className='tr_out'" class="tr_out">
                            ...
                            <td><img alt="<?php echo $partner['file']; ?>" title="<?php echo $partner['file']; ?>" src="<?php echo BASE_PATH.UPLOAD_PATH.'partners'.DS.$partner['id']."-".$partner['file']; ?>"/></td>
                            <td>
                                <span>
