...
<div id="page">
    ...
    <div id="content">
        ...
        <div class="post">
            <h2 class="title">banners / add new</h2>
            ...
            <form id="form" name="form" action="<?php echo BASE_PATH.'admin'.DS.'banners'.DS.'submit'.DS;?>" method="post" enctype="multipart/form-data">
